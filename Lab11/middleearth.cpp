 ...
 * @brief The middleearth class creates middleearth's  cities, maps, and distances between cities and prints it out.
 */
...
/** @brief MiddleEarth constructor named Iluvatar
 * Sets up a random number seed
 * Counts the number of cities in the array
 * Copies all the cities into a mutable vector
 * Shuffles all the cities and removes the ones that won't be used
 * Computes random city positions
 * Compute the 2D distance array
 *
 * @param xsize: middleearth's  x-axis size
 * @param ysize: middleearth's y-axis size
 * @param num_cities: number of cities
 * @param seed: used to construct middlearth
 */
...
/** @brief prints out all the information of middlearth
 */
// The Mouth of Sauron!
 ...
 * @details The starting city is the original start point as well as the end point.
 * @param length
 * @if length > cities.size()
 * you cannot ask for an itinerary of more than length -> exit.
 * @else vector<string> itinerary
 * shuffle cities, erase unneeded ones, and return itinerary
 * @endif
